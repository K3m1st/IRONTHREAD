...
You have access to everything in the current session's context. Use it. You also read all files in `../shared/` to fill gaps.

---

## Step 1 — Gather Everything

Read ALL of the following from `../shared/` (skip any that don't exist):
- `target.txt`
- `operation.md`
- `scouting_report.md` and `scouting_report.json`
- `attack_surface.md`
- `webdig_findings.md` and `webdig_findings.json`
- `noire_findings.md` and `noire_findings.json`
- `handoff.json`
- `exploit_log.md`
